...
## Project Structure
    ...
    ├── testapiautoteammemb_60167  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_60167`
...
2. Clone this repo and `cd testapiautoteammemb_60167`
